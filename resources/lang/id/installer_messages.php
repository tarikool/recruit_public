...
return [
     ...
     */
    'installed' => [
        'success_log_message' => 'QuickRecruit Installer berhasil DIPASANG pada ',
    ],
    ...
    'updater' => [
        ...
        'log' => [
            'success_message' => 'QuickRecruit Installer berhasil DIPERBARUI pada ',
        ],
    ],
];
