...
return array (
  ...
  array (
    ...
    'delete' => '<i class="fas fa-trash" aria-hidden="true"></i>  <span class="hidden-xs hidden-sm">Apagar</span><span class="hidden-xs hidden-sm hidden-md"> Usuário</span>',
    'show' => '<i class="fas fa-eye" aria-hidden="true"></i> <span class="hidden-xs hidden-sm">Mostrar</span><span class="hidden-xs hidden-sm hidden-md"> Usuário</span>',
    'edit' => '<i class="fas fa-pencil fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm">Editar</span><span class="hidden-xs hidden-sm hidden-md"> Usuário</span>',
    ...
    'delete-user' => '<i class="fas fa-trash" aria-hidden="true"></i>  <span class="hidden-xs">Apagar</span><span class="hidden-xs"> Usuário</span>',
    'edit-user' => '<i class="fas fa-pencil" aria-hidden="true"></i> <span class="hidden-xs">Editar</span><span class="hidden-xs"> Usuário</span>',
  ),
  'tooltips' => 
  array (
    'delete' => 'Deletar',
