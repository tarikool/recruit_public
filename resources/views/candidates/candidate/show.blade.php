    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{route('candidates.edit',$candidate)}}" class="btn btn-primary">
                    <i class="fas fa-pen"> {{__('Edit Profile')}}</i>
                </a>
            </div>

            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active">
                    <a href="{{route('candidates.show',auth()->user()->candidate->id)}}">{{__('Profile')}}</a>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="author-box-details">
                                ...
                                <div class="author-box-description">
                                    <p>{!! !blank($candidate->skillset)?clean($candidate->skillset):__("Please Update Your Profile With Skill") !!}</p>
                                </div>
                                <a href="{{route('candidates.edit',$candidate)}}" target="_blank"
                                   class="btn btn-social-icon mr-1 btn-info" title="{{__('Edit Profile')}}">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card card-body card-primary">
                                            <h5 class="font-weight-bolder text-dark pb-2">{{__('Profile Details')}}</h5>
                                            <div class="row">
                                        ...
                                        <table class="table table-bordered table-striped dataTable" style="width:100%">
                                            ...
                                            @foreach($assignedJobs as $assignedJob)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-icon btn-sm" data-toggle="tooltip"
                                                           data-placement="top" title="" target="_blank" data-original-title="{{__('Job Details')}}"
                                                           href="{{route('client.jobs.detail',$assignedJob->slug)}}">
