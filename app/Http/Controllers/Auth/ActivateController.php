...
class ActivateController extends Controller
{
    ...
    private static $adminHomeRoute = 'dashboard.recruiter';
    private static $candidateHomeRoute = 'public.home';
    ...
    public static function getCandidateHomeRoute()
    {
        return self::$candidateHomeRoute;
    }
    ...
    public static function activeRedirect($user, $currentRoute)
    {
        if ($user->activated) {
            ...
            if ($user->candidate){
                return redirect()->route(self::getCandidateHomeRoute())
                    ->with('status', 'info')
                    ->with('message', $message);
            }
